...
Simplified GCN training on Citeseer based on DGL official examples:
...
class GCNs(nn.Module):
    ...
    def __init__(self):
        ...
        self.gcn1 = GCN(3703, 16, nn.ReLU())  # 3703 features
        self.gcn2 = GCN(16, 6, nn.LogSoftmax(dim=1))  # 6 classes
...
g, features, labels, mask, val_mask, test_mask = load_citeseer_data()

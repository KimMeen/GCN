...
Simplified GCN training on Pubmed based on DGL official examples:
...
class GCNs(nn.Module):
    ...
    def __init__(self):
        ...
        self.gcn1 = GCN(500, 16, nn.ReLU())  # 500 features
        self.gcn2 = GCN(16, 3, nn.LogSoftmax(dim=1))  # 3 classes
...
g, features, labels, mask, val_mask, test_mask = load_pubmed_data()
